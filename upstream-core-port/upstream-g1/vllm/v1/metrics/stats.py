...
class SchedulerStats:
    ...
    # `scheduler_stats.num_scheduled_prompt_tokens` in
    # _track_scheduler_stats (prompt throughput per iteration). The v84
    # SchedulerStats carried this field; stock default 0 keeps the metric
    # correct because the fork-compat scheduler populates it in make_stats.
